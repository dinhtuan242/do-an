                        ...
                        <table class="table table-bordered table-striped table-hover dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Lý do tố cáo</th>
                                    <th>Xem</th>
                                    <th width="150">Khóa tài khoản</th>
                                </tr>
                            </thead>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($user->status == '1')
                                            ...
                                            <form action="{{route('admin.user-manager.update',$user->id)}}" method="POST" id="block-user-{{$user->id}}" style="display:none;">
                                                @csrf
                                                @method('PUT')
                                            </form>
                                        @else
